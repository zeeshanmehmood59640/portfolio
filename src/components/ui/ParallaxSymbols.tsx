...
const SYMBOLS = [
  ...
  { text: "{}",    left: "88%", top: "20%", duration: 22, delay: 2   },
  { text: "[]",    left: "76%", top: "46%", duration: 16, delay: 4   },
  { text: "=>",    left: "13%", top: "56%", duration: 24, delay: 1   },
  { text: "#",     left: "92%", top: "68%", duration: 20, delay: 3   },
  { text: "const", left: "3%",  top: "78%", duration: 19, delay: 5   },
  { text: "async", left: "83%", top: "33%", duration: 21, delay: 1.5 },
    ...
    <>
      {SYMBOLS.map((s, i) => (
        <span
          key={i}
          aria-hidden="true"
          className="fixed pointer-events-none select-none font-mono font-bold z-[2] text-indigo-600/10 dark:text-indigo-300/25 animate-float"
          style={{
            left: s.left,
            top: s.top,
