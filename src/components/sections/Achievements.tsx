      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-col gap-6">
            ...
            <motion.div
              variants={fadeUp}
              className="relative rounded-2xl border border-yellow-400/30 dark:border-yellow-400/20 p-8 overflow-hidden hover:shadow-[0_0_40px_rgba(234,179,8,0.12)] transition-all duration-500 bg-white/60 dark:bg-[#300b40]/15"
            >
              ...
              <div className="flex items-start gap-6">
                <div className="flex-shrink-0 w-16 h-16 rounded-full bg-yellow-400/15 dark:bg-yellow-400/10 flex items-center justify-center">
                ...
                <div className="flex-1">
                  ...
                  <h3 className="font-heading text-2xl font-bold text-dark-text dark:text-[#FAF9E0] mb-1">
                    {achievement.title}
                  </h3>
                  <p className="text-sm text-primary dark:text-secondary font-heading font-semibold mb-5">
            ...
            {certifications.map((cert, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="relative rounded-2xl border border-purple-400/30 dark:border-purple-400/20 p-8 overflow-hidden hover:shadow-[0_0_40px_rgba(147,51,234,0.12)] transition-all duration-500 bg-white/60 dark:bg-[#300b40]/15"
              >
                ...
                <div className="flex items-start gap-6">
                  <div className="flex-shrink-0 w-16 h-16 rounded-full bg-purple-400/15 dark:bg-purple-400/10 flex items-center justify-center">
